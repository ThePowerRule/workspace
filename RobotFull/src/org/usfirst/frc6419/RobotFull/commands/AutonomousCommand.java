...
public class AutonomousCommand extends Command {
	...
	protected void execute() {
		...
		else if(Timer.getMatchTime()<.5+forwardTime){
			driveMotor1.set(0);
			driveMotor2.set(0);
			driveMotor3.set(0);
			driveMotor4.set(0);
		}
		else if(Timer.getMatchTime()<.5+forwardTime+sidewaysTime){
			driveMotor1.set(m1);
			driveMotor2.set(m2);
			driveMotor3.set(m3);
			driveMotor4.set(m4);
		}
		else if(Timer.getMatchTime()<.5+forwardTime+2*sidewaysTime){
		...
		else if(Timer.getMatchTime()<1.5+forwardTime+2*sidewaysTime){
