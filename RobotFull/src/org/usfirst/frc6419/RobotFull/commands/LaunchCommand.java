...
public class LaunchCommand extends CommandGroup {
    ...
    public void teleopControls(){
    	...
    	if(Robot.oi.getDriveJoystick().getRawButton(9)) isClimbingReverse = true;
    	if(Robot.oi.getDriveJoystick().getRawButton(12)) isClimbingReverse = false;
	...
	public boolean isReverse() {
		return isClimbingReverse;
	}

	public void setReverse(boolean isReverse) {
		this.isClimbingReverse = isReverse;
	}
}
